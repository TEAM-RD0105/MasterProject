 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Wed Aug 13 10:23:30 2025
 */

#define S_FUNCTION_LEVEL               2
#define S_FUNCTION_NAME                TLE92466_VFS_CH
...
/* Input Port  0 */
#define IN_PORT_0_NAME                 CH_Limit_mA
#define INPUT_0_DIMS_ND                {6}
...
/* Input Port  1 */
#define IN_PORT_1_NAME                 Clear_Faults
...
/* Output Port  0 */
#define OUT_PORT_0_NAME                CH_Current
#define OUTPUT_0_DIMS_ND               {6}
...
/* Output Port  1 */
#define OUT_PORT_1_NAME                Faults
#define OUTPUT_1_DIMS_ND               {6}
#define OUTPUT_1_NUM_ELEMS             6
...
/* Output Port  2 */
#define OUT_PORT_2_NAME                CH_Voltage
#define OUTPUT_2_DIMS_ND               {6}
#define OUTPUT_2_NUM_ELEMS             6
...
/* Parameter 0 */
#define PARAMETER_0_NAME               CH_Frequency_Hz
...
extern void TLE92466_VFS_CH_Start_wrapper(const real_T *CH_Frequency_Hz, const
  int_T p_width0);
extern void TLE92466_VFS_CH_Outputs_wrapper(const real_T *CH_Limit_mA,
  const uint8_T *Clear_Faults,
  real_T *CH_Current,
  uint16_T *Faults,
  real_T *CH_Voltage,
  const real_T *CH_Frequency_Hz, const int_T p_width0);
extern void TLE92466_VFS_CH_Terminate_wrapper(const real_T *CH_Frequency_Hz,
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port CH_Limit_mA of S-Function TLE92466_VFS_CH");
      return;
    }
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port Clear_Faults of S-Function TLE92466_VFS_CH");
      return;
    }
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port CH_Current of S-Function TLE92466_VFS_CH");
      return;
    }
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port Faults of S-Function TLE92466_VFS_CH");
      return;
    }
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port CH_Voltage of S-Function TLE92466_VFS_CH");
      return;
    }
...
static void mdlStart(SimStruct *S)
{
  ...
  const real_T *CH_Frequency_Hz = (const real_T *) mxGetDoubles(PARAM_DEF0(S));
  TLE92466_VFS_CH_Start_wrapper(CH_Frequency_Hz, p_width0);
}
...
{
  const real_T *CH_Limit_mA = (real_T *) ssGetInputPortRealSignal(S, 0);
  const uint8_T *Clear_Faults = (uint8_T *) ssGetInputPortRealSignal(S, 1);
  real_T *CH_Current = (real_T *) ssGetOutputPortRealSignal(S, 0);
  uint16_T *Faults = (uint16_T *) ssGetOutputPortRealSignal(S, 1);
  real_T *CH_Voltage = (real_T *) ssGetOutputPortRealSignal(S, 2);
  const int_T p_width0 = mxGetNumberOfElements(PARAM_DEF0(S));
  const real_T *CH_Frequency_Hz = (const real_T *) mxGetDoubles(PARAM_DEF0(S));
  TLE92466_VFS_CH_Outputs_wrapper(CH_Limit_mA, Clear_Faults, CH_Current, Faults,
    CH_Voltage, CH_Frequency_Hz, p_width0);
}
...
static void mdlTerminate(SimStruct *S)
{
  const int_T p_width0 = mxGetNumberOfElements(PARAM_DEF0(S));
  const real_T *CH_Frequency_Hz = (const real_T *) mxGetDoubles(PARAM_DEF0(S));
  TLE92466_VFS_CH_Terminate_wrapper(CH_Frequency_Hz, p_width0);
}
