...
*                                   FILE VERSION CHECKS
==================================================================================================*/
/* Checks against Mscm_Ip_MBDT_PBcfg.h */
#if (RM_MSCM_IP_CFG_VENDOR_ID != RM_MSCM_IP_PBCFG_MBDT_VENDOR_ID)
    #error "Mscm_Ip_Cfg.h and Mscm_Ip_MBDT_PBcfg.h have different vendor ids"
#endif
#if ((RM_MSCM_IP_CFG_AR_RELEASE_MAJOR_VERSION    != RM_MSCM_IP_PBCFG_MBDT_AR_RELEASE_MAJOR_VERSION) || \
     (RM_MSCM_IP_CFG_AR_RELEASE_MINOR_VERSION    != RM_MSCM_IP_PBCFG_MBDT_AR_RELEASE_MINOR_VERSION) || \
     (RM_MSCM_IP_CFG_AR_RELEASE_REVISION_VERSION != RM_MSCM_IP_PBCFG_MBDT_AR_RELEASE_REVISION_VERSION))
     #error "AUTOSAR Version Numbers of Mscm_Ip_Cfg.h and Mscm_Ip_MBDT_PBcfg.h are different"
#endif
#if ((RM_MSCM_IP_CFG_SW_MAJOR_VERSION != RM_MSCM_IP_PBCFG_MBDT_SW_MAJOR_VERSION) || \
     (RM_MSCM_IP_CFG_SW_MINOR_VERSION != RM_MSCM_IP_PBCFG_MBDT_SW_MINOR_VERSION) || \
     (RM_MSCM_IP_CFG_SW_PATCH_VERSION != RM_MSCM_IP_PBCFG_MBDT_SW_PATCH_VERSION))
    #error "Software Version Numbers of Mscm_Ip_Cfg.h and Mscm_Ip_MBDT_PBcfg.h are different"
#endif
