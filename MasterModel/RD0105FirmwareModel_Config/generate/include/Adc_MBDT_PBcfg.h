...
#define ADC_SW_MAJOR_VERSION_MBDT_PBCFG               6
...
#define ADC_CFGSET_MBDT_GROUP_6_CHANNELS      (1U)
#define ADC_CFGSET_MBDT_GROUP_7_CHANNELS      (1U)
#define ADC_CFGSET_MBDT_GROUP_8_CHANNELS      (1U)
#define ADC_CFGSET_MBDT_GROUP_9_CHANNELS      (1U)
#define ADC_CFGSET_MBDT_GROUP_10_CHANNELS      (1U)
#define ADC_CFGSET_MBDT_GROUP_11_CHANNELS      (1U)
#define ADC_CFGSET_MBDT_GROUP_12_CHANNELS      (1U)
#define ADC_CFGSET_MBDT_GROUP_13_CHANNELS      (1U)

/**
* @brief          Total number of groups in Config.
*
*/
#define ADC_GROUPS_MBDT                       (14U)
...
void Adc_Adc0Group2Notification(void);
void Adc_Adc2Group0Notification(void);
void Adc_Adc2Group1Notification(void);
void Adc_Adc2Group2Notification(void);
void Adc_Adc0Group3Notification(void);
void Adc_Adc0Group4Notification(void);
void Adc_Adc2Group3Notification(void);
void Adc_Adc2Group4Notification(void);
void Adc_Adc2Group5Notification(void);
void Adc_Adc2Group6Notification(void);
