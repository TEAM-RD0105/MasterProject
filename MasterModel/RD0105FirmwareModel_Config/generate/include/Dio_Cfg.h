...
/**
* @brief          Symbolic name for the channel DI_DescentModeSwitch1.
*
*/
#define DioConf_DioChannel_DI_DescentModeSwitch1  ((uint16)0x001fU)
/**
* @brief          Symbolic name for the channel DI_ESTOP.
*
*/
#define DioConf_DioChannel_DI_ESTOP  ((uint16)0x001eU)
/**
...
/**
* @brief          Symbolic name for the channel DI_KL15.
*
*/
#define DioConf_DioChannel_DI_KL15  ((uint16)0x0033U)
/* ---------- PTC_H ---------- */
...
/**
* @brief          Symbolic name for the channel VFS_ENABLE.
*
*/
#define DioConf_DioChannel_VFS_ENABLE  ((uint16)0x0055U)
/**
...
/**
* @brief          Symbolic name for the channel VFS_FAULT.
*
*/
#define DioConf_DioChannel_VFS_FAULT  ((uint16)0x0052U)
/**
* @brief          Symbolic name for the channel DI_In1.
*
*/
#define DioConf_DioChannel_DI_In1  ((uint16)0x005cU)
/**
* @brief          Symbolic name for the channel DI_In4.
*
*/
#define DioConf_DioChannel_DI_In4  ((uint16)0x005fU)
/**
* @brief          Symbolic name for the channel DI_In3.
*
*/
#define DioConf_DioChannel_DI_In3  ((uint16)0x005eU)
/**
* @brief          Symbolic name for the channel VFS_RESET.
*
*/
#define DioConf_DioChannel_VFS_RESET  ((uint16)0x0053U)
/* ---------- PTD_L ---------- */
...
/**
* @brief          Symbolic name for the channel DI_DescentModeSwitch2.
*
*/
#define DioConf_DioChannel_DI_DescentModeSwitch2  ((uint16)0x006fU)
/* ---------- PTE_L ---------- */
...
/**
* @brief          Symbolic name for the channel DI_In5.
*
*/
#define DioConf_DioChannel_DI_In5  ((uint16)0x0087U)
/**
* @brief          Symbolic name for the channel VRC_CTRL.
*
*/
#define DioConf_DioChannel_VRC_CTRL  ((uint16)0x008dU)
/* ---------- PTC_L ---------- */
...
/**
* @brief          Symbolic name for the channel DI_In2.
*
*/
#define DioConf_DioChannel_DI_In2  ((uint16)0x0048U)
/* ---------- PTB_L ---------- */
...
/**
* @brief          Symbolic name for the channel DO_IgnitionRelay.
*
*/
#define DioConf_DioChannel_DO_IgnitionRelay  ((uint16)0x002bU)
/* ---------- PTD_H ---------- */
...
/**
* @brief          Symbolic name for the channel DO_CoolingPumpRelay.
*
*/
#define DioConf_DioChannel_DO_CoolingPumpRelay  ((uint16)0x0076U)
