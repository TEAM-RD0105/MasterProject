...
==================================================================================================*/
/* Logic Channel 0 */
#define MCL_FLEXIOCOMMON_0_FLEXIOMCLLOGICCHANNELS_RX      ((uint32)CHANNEL_0)
/* Logic Channel 1 */
#define MCL_FLEXIOCOMMON_0_FLEXIOMCLLOGICCHANNELS_TX      ((uint32)CHANNEL_1)
/* Logic Channel 2 */
#define MCL_FLEXIOCOMMON_0_FLEXIOMCLLOGICCHANNELS_SCL      ((uint32)CHANNEL_2)
/* Logic Channel 3 */
#define MCL_FLEXIOCOMMON_0_FLEXIOMCLLOGICCHANNELS_SDA      ((uint32)CHANNEL_3)
#define FLEXIO_MCL_IP_NOF_CFG_LOGIC_INSTANCES      ((uint32)1U)
#define MCL_START_SEC_CONFIG_DATA_UNSPECIFIED
#include "Mcl_MemMap.h"
/* Flexio instance init configuration. */extern const Flexio_Ip_InstanceInitType Flexio_Ip_xFlexioInit_MBDT;
