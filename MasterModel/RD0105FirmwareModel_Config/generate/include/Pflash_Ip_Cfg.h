...
#include "Pflash_Ip_MBDT_PBcfg.h"
...
*                                     FILE VERSION CHECKS
==================================================================================================*/
/* Checks against Pflash_Ip_MBDT_PBcfg.h */
#if (RM_PFLASH_IP_CFG_VENDOR_ID != RM_PFLASH_IP_PBCFG_MBDT_VENDOR_ID)
    #error "Pflash_Ip_Cfg.h and Pflash_Ip_MBDT_PBcfg.h have different vendor ids"
#endif
#if ((RM_PFLASH_IP_CFG_AR_RELEASE_MAJOR_VERSION    != RM_PFLASH_IP_PBCFG_MBDT_AR_RELEASE_MAJOR_VERSION) || \
     (RM_PFLASH_IP_CFG_AR_RELEASE_MINOR_VERSION    != RM_PFLASH_IP_PBCFG_MBDT_AR_RELEASE_MINOR_VERSION) || \
     (RM_PFLASH_IP_CFG_AR_RELEASE_REVISION_VERSION != RM_PFLASH_IP_PBCFG_MBDT_AR_RELEASE_REVISION_VERSION))
     #error "AUTOSAR Version Numbers of Pflash_Ip_Cfg.h and Pflash_Ip_MBDT_PBcfg.h are different"
#endif
#if ((RM_PFLASH_IP_CFG_SW_MAJOR_VERSION != RM_PFLASH_IP_PBCFG_MBDT_SW_MAJOR_VERSION) || \
     (RM_PFLASH_IP_CFG_SW_MINOR_VERSION != RM_PFLASH_IP_PBCFG_MBDT_SW_MINOR_VERSION) || \
     (RM_PFLASH_IP_CFG_SW_PATCH_VERSION != RM_PFLASH_IP_PBCFG_MBDT_SW_PATCH_VERSION))
    #error "Software Version Numbers of Pflash_Ip_Cfg.h and Pflash_Ip_MBDT_PBcfg.h are different"
#endif
