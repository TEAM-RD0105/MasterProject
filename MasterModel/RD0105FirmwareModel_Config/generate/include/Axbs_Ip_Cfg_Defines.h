...
#define RM_AXBS_IP_CFG_DEFINES_SW_MAJOR_VERSION             6
...
#if ((RM_AXBS_IP_CFG_DEFINES_AR_RELEASE_MAJOR_VERSION != STD_AR_RELEASE_MAJOR_VERSION) || \
    (RM_AXBS_IP_CFG_DEFINES_AR_RELEASE_MINOR_VERSION  != STD_AR_RELEASE_MINOR_VERSION))
    #error "AutoSar Version Numbers of Axbs_Ip_Cfg_Defines.h and Std_Types.h are different"
#endif
#endif
