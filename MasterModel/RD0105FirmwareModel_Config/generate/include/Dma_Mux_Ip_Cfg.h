...
#include "Dma_Mux_Ip_MBDT_PBcfg.h"
...
/* Checks against Dma_Mux_Ip_MBDT_PBcfg.h */
#if (RM_DMA_MUX_IP_CFG_VENDOR_ID != RM_DMA_MUX_IP_MBDT_PBCFG_VENDOR_ID)
    #error "Dma_Mux_Ip_Cfg.h and Dma_Mux_Ip_MBDT_PBcfg.h have different vendor ids"
#endif
#if (( RM_DMA_MUX_IP_CFG_AR_RELEASE_MAJOR_VERSION    != RM_DMA_MUX_IP_MBDT_PBCFG_AR_RELEASE_MAJOR_VERSION) || \
     ( RM_DMA_MUX_IP_CFG_AR_RELEASE_MINOR_VERSION    != RM_DMA_MUX_IP_MBDT_PBCFG_AR_RELEASE_MINOR_VERSION) || \
     ( RM_DMA_MUX_IP_CFG_AR_RELEASE_REVISION_VERSION != RM_DMA_MUX_IP_MBDT_PBCFG_AR_RELEASE_REVISION_VERSION) \
    )
     #error "AUTOSAR Version Numbers of Dma_Mux_Ip_Cfg.h and Dma_Mux_Ip_MBDT_PBcfg.h are different"
#endif
#if (( RM_DMA_MUX_IP_CFG_SW_MAJOR_VERSION != RM_DMA_MUX_IP_MBDT_PBCFG_SW_MAJOR_VERSION) || \
     ( RM_DMA_MUX_IP_CFG_SW_MINOR_VERSION != RM_DMA_MUX_IP_MBDT_PBCFG_SW_MINOR_VERSION) || \
     ( RM_DMA_MUX_IP_CFG_SW_PATCH_VERSION != RM_DMA_MUX_IP_MBDT_PBCFG_SW_PATCH_VERSION) \
    )
    #error "Software Version Numbers of Dma_Mux_Ip_Cfg.h and Dma_Mux_Ip_MBDT_PBcfg.h are different"
#endif
