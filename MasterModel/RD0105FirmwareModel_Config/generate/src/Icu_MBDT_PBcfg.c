...
#define ICU_MBDT_PBCFG_SW_MAJOR_VERSION_C             6
...
*/
static const uint8 Icu_ChIndexMap_PB_MBDT[8U] = 
{
    0U,
    1U,
    2U,
...
*/
static const Icu_ChannelConfigType Icu_ChannelConfig_PB_MBDT[8U]=
{
    /* IcuChannel_0 */
    {
        ...
        &MBDT_USER_SW0_callback,    /* Icu_ChannelNotification */
#if ((ICU_SIGNALMEASUREMENT_USES_DMA == STD_ON) || (ICU_TIMESTAMP_USES_DMA == STD_ON))
    ...
    /* IcuChannel_1 */
    {
        ...
        NULL_PTR,    /* Icu_ChannelNotification */
#if ((ICU_SIGNALMEASUREMENT_USES_DMA == STD_ON) || (ICU_TIMESTAMP_USES_DMA == STD_ON))
        (Mcl_ChannelType)NoMclDmaChannel,    /* Mcl_DmaChannel */
#endif
#if (ICU_OVERFLOW_NOTIFICATION_API == STD_ON)
        &MBDT_ICU_OverflowNotif,    /* Icu_ChOverflowNotification */
#endif  /* ICU_OVERFLOW_NOTIFICATION_API */
#if (ICU_REPORT_WAKEUP_SOURCE == STD_ON)
        (Icu_WakeupValueType)0U,    /* Icu_Channel_WakeupValue */
#endif /* (ICU_REPORT_WAKEUP_SOURCE == STD_ON) */
    ...
    /* IcuChannel_2 */
    {
        ...
        &MBDT_ICU_Timestamp_Callback,    /* Icu_ChannelNotification */
#if ((ICU_SIGNALMEASUREMENT_USES_DMA == STD_ON) || (ICU_TIMESTAMP_USES_DMA == STD_ON))
        (Mcl_ChannelType)NoMclDmaChannel,    /* Mcl_DmaChannel */
#endif
#if (ICU_OVERFLOW_NOTIFICATION_API == STD_ON)
    ...
    /* IcuChannel_4 */
    {
        ...
        (Icu_WakeupValueType)0U,    /* Icu_Channel_WakeupValue */
#endif /* (ICU_REPORT_WAKEUP_SOURCE == STD_ON) */
        &Icu_Ipw_IpChannelConfig_PB_MBDT[4U] /* Ipw channel pointer */
    },
    /* IcuChannel_5 */
    {
        (boolean)FALSE,    /* Wakeup capability */
        ...
        (Icu_WakeupValueType)0U,    /* Icu_Channel_WakeupValue */
#endif /* (ICU_REPORT_WAKEUP_SOURCE == STD_ON) */
        &Icu_Ipw_IpChannelConfig_PB_MBDT[5U] /* Ipw channel pointer */
    },
    /* IcuChannel_6 */
    {
        (boolean)FALSE,    /* Wakeup capability */
        ...
        (Icu_WakeupValueType)0U,    /* Icu_Channel_WakeupValue */
#endif /* (ICU_REPORT_WAKEUP_SOURCE == STD_ON) */
        &Icu_Ipw_IpChannelConfig_PB_MBDT[6U] /* Ipw channel pointer */
    },
    /* IcuChannel_7 */
    {
        (boolean)FALSE,    /* Wakeup capability */
        ...
        (Icu_WakeupValueType)0U,    /* Icu_Channel_WakeupValue */
#endif /* (ICU_REPORT_WAKEUP_SOURCE == STD_ON) */
        &Icu_Ipw_IpChannelConfig_PB_MBDT[7U] /* Ipw channel pointer */
    }
};
