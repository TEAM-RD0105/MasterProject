...
VAR_ALIGN(static Spi_DataBufferType Spi_BufferTX_MBDT_SpiChannel_0[4], 8)
VAR_ALIGN(static Spi_DataBufferType Spi_BufferRX_MBDT_SpiChannel_0[4], 8)
#else
/** Compiler_Warning: It is intended for aligning memory. */
VAR_ALIGN(static Spi_DataBufferType Spi_BufferTX_MBDT_SpiChannel_0[4], 4)
VAR_ALIGN(static Spi_DataBufferType Spi_BufferRX_MBDT_SpiChannel_0[4], 4)
#endif
...
static Spi_BufferDescriptorType Spi_Buffer_MBDT_SpiChannel_0 =
{
    ...
    Spi_BufferTX_MBDT_SpiChannel_0,  /* BufferTX */
    Spi_BufferRX_MBDT_SpiChannel_0   /* BufferRX */
};
