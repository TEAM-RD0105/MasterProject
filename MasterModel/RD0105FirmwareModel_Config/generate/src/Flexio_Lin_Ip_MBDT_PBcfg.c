...
#define FLEXIO_LIN_IP_MBDT_PBCFG_SW_MAJOR_VERSION_C              6
...
/* Check if current file and Flexio_Lin_Ip_Cfg header file are of the same Software version */
    ...
    #if (FLEXIO_LIN_IP_HAS_DMA_ENABLED == STD_ON)
        #if ((FLEXIO_LIN_IP_MBDT_PBCFG_AR_RELEASE_MAJOR_VERSION_C != DMA_IP_AR_RELEASE_MAJOR_VERSION) || \
             (FLEXIO_LIN_IP_MBDT_PBCFG_AR_RELEASE_MINOR_VERSION_C != DMA_IP_AR_RELEASE_MINOR_VERSION) \
            )
            #error "AutoSar Version Numbers of Flexio_Lin_Ip_MBDT_PBcfg.c and Dma_Ip.h are different"
        #endif
    #endif
#endif
/*==================================================================================================
...
const Flexio_Lin_Ip_UserConfigType Flexio_Lin_Ip_pxHwConfigPB_0_MBDT=
{
    ...
    FLEXIO_LIN_IP_USING_INTERRUPTS,
#if (FLEXIO_LIN_IP_HAS_DMA_ENABLED == STD_ON)
