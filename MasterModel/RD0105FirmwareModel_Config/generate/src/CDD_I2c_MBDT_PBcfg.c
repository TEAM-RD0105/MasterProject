...
#define CDD_I2C_MBDT_PBCFG_SW_MAJOR_VERSION_C              6
...
*                                       FILE VERSION CHECKS
==================================================================================================*/
/* Check if current file and CDD_I2c.h file are of the same vendor */
#if (CDD_I2C_MBDT_PBCFG_VENDOR_ID_C != CDD_I2C_VENDOR_ID)
    #error "CDD_I2c_MBDT_PBcfg.c and CDD_I2c.h have different vendor ids"
#endif
/* Check if current file and CDD_I2c.h file are of the same Autosar version */
#if ((CDD_I2C_MBDT_PBCFG_AR_RELEASE_MAJOR_VERSION_C    != CDD_I2C_AR_RELEASE_MAJOR_VERSION) || \
     (CDD_I2C_MBDT_PBCFG_AR_RELEASE_MINOR_VERSION_C    != CDD_I2C_AR_RELEASE_MINOR_VERSION) || \
     (CDD_I2C_MBDT_PBCFG_AR_RELEASE_REVISION_VERSION_C != CDD_I2C_AR_RELEASE_REVISION_VERSION))
    #error "AutoSar Version Numbers of CDD_I2c_MBDT_PBcfg.c and CDD_I2c.h are different"
#endif
/* Check if current file and CDD_I2c.h file are of the same Software version */
#if ((CDD_I2C_MBDT_PBCFG_SW_MAJOR_VERSION_C != CDD_I2C_SW_MAJOR_VERSION) || \
     (CDD_I2C_MBDT_PBCFG_SW_MINOR_VERSION_C != CDD_I2C_SW_MINOR_VERSION) || \
     (CDD_I2C_MBDT_PBCFG_SW_PATCH_VERSION_C != CDD_I2C_SW_PATCH_VERSION))
    #error "Software Version Numbers of CDD_I2c_MBDT_PBcfg.c and CDD_I2c.h are different"
#endif
