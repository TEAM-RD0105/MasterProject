...
#define LCU_IP_MBDT_PBCFG_SW_MAJOR_VERSION_C                 6
...
static const Lcu_Ip_LogicInstanceType * const Lcu_Ip_ppxLogicInstanceArrayPB_MBDT[1U] =
{
...
static const Lcu_Ip_LogicInputType * const Lcu_Ip_ppxLogicInputArrayPB_MBDT[1U] =
{
    &LogicInput0PB_MBDT,
};
...
/* @violates @ref LCU_IP_PBCFG_C_REF_1 MISRA 2012 Required Directive 4.10, Precautions shall be taken in order to prevent the contents of a header file being included more than once. */
#include "Mcl_MemMap.h"
static Lcu_Ip_HwOutputStateType * Lcu_Ip_ppxHwOutputStateArrayPB_MBDT[1U] =
{
...
static const Lcu_Ip_LogicOutputType * const Lcu_Ip_ppxLogicOutputArrayPB_MBDT[1U] =
{
    &LogicOutput0PB_MBDT,
};
...
const Lcu_Ip_InitType Lcu_Ip_xLcuInitPB_MBDT =
{
   ...
   /* const uint8 NumOfLogicInput                                               */ 1U,
   /* const uint8 NumOfLogicOutput                                              */ 1U,
};
