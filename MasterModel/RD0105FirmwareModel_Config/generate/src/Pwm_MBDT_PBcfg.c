...
extern void PwmChannel_9_Callback(void);

extern void PwmChannel_10_Callback(void);

extern void PwmChannel_11_Callback(void);
...
static const Pwm_ChannelConfigType Pwm_Channels_MBDT_PB[PWM_MBDT_PB_CFG_CHANNELS_COUNT] =
{
    ...
    /* PwmChannel_12 */
    {
        ...
        /** @brief  Ip channel configuration */
        {
            ...
            PWM_CHANNEL_EMIOS,
            /** @brief  Pointer to the Emios ip Configuration */
            (const void *)(&Emios_Pwm_Ip_MBDT_I2_Ch22),
        #if (defined(PWM_FTM_USED) && (PWM_FTM_USED == STD_ON))
            /** @brief  Pointer to the Ftm ip Channel Configuration */
            NULL_PTR,
        #endif
        ...
        #endif
            /** @brief  Hardware Channel Instance ID */
            (Pwm_IpwInstanceType)EMIOS_PWM_IP_MBDT_I2_CH22_CFG,
            /** @brief The duty cycle of this channel */
            2048U
        },
        /** @brief  The state of the channel output in idle mode */
    ...
    /* PwmChannel_13 */
    {
        ...
        /** @brief  Ip channel configuration */
        {
            ...
            PWM_CHANNEL_EMIOS,
            /** @brief  Pointer to the Emios ip Configuration */
            (const void *)(&Emios_Pwm_Ip_MBDT_I2_Ch17),
        #if (defined(PWM_FTM_USED) && (PWM_FTM_USED == STD_ON))
            /** @brief  Pointer to the Ftm ip Channel Configuration */
            NULL_PTR,
        #endif
        ...
        #endif
            /** @brief  Hardware Channel Instance ID */
            (Pwm_IpwInstanceType)EMIOS_PWM_IP_MBDT_I2_CH17_CFG,
            /** @brief The duty cycle of this channel */
            2048U
        },
        /** @brief  The state of the channel output in idle mode */
