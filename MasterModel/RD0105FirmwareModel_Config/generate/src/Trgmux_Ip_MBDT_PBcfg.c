...
#define TRGMUX_IP_MBDT_PBCFG_SW_MAJOR_VERSION_C              6
...
{
    /* uint8 LogicChannel; */   (uint8)TRGMUX_LOGIC_GROUP_0_TRIGGER_0_MBDT,
...
static const Trgmux_Ip_LogicTriggerType * const LogicTriggerArray[1U] =
{
