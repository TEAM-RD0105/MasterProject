...
#define LPUART_LIN_IP_MBDT_PBCFG_SW_MAJOR_VERSION_C              6
...
/* Check if current file and Lpuart_Lin_Ip_Cfg header file are of the same Software version */
    ...
    #if (LPUART_LIN_IP_HAS_DMA_ENABLED == STD_ON)
        #if ((LPUART_LIN_IP_MBDT_PBCFG_AR_RELEASE_MAJOR_VERSION_C != DMA_IP_AR_RELEASE_MAJOR_VERSION) || \
             (LPUART_LIN_IP_MBDT_PBCFG_AR_RELEASE_MINOR_VERSION_C != DMA_IP_AR_RELEASE_MINOR_VERSION) \
            )
            #error "AutoSar Version Numbers of Lpuart_Lin_Ip_MBDT_PBcfg.c and Dma_Ip.h are different"
        #endif
    #endif
#endif
/*==================================================================================================
