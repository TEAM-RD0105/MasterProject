...
#define WKPU_IP_IRQ_SW_MAJOR_VERSION_C             6
...
/*==================================================================================================*/
/**
* @brief      Wkpu_Ip_ProcessSingleInterrupt
* @details
*
...
static inline void Wkpu_Ip_ProcessSingleInterrupt(void)
{
    ...
    for (u8WkpuChannel = 0; u8WkpuChannel < (uint8)WKPU_IP_NUM_OF_CHANNELS_IN_ONE_REG_32; u8WkpuChannel++)
    {
    ...
    for (u8WkpuChannel = 0; u8WkpuChannel < (uint8)WKPU_IP_NUM_OF_CHANNELS_IN_ONE_REG_64; u8WkpuChannel++)
    {
        if (0x0U != (u32reg_WKPU_WISR & u32ChannelMask))
        {
            /* Clear pending interrupt serviced */
...
#if (defined(WKPU_ICU_SINGLE_INTERRUPT) && (WKPU_ICU_SINGLE_INTERRUPT == STD_ON))
/**
 * @brief This function will handle the callback functions for both HLD and IPL.
 *
 * @param hwChannel   : wkpu encoded hardware channel
 */
static inline void Wkpu_Ip_Callback(uint8 hwChannel)
{
