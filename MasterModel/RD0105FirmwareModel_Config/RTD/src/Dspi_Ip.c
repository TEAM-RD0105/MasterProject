...
#include "OsIf.h"
   ...
   #define USER_MODE_REG_PROT_ENABLED    (DSPI_IP_ENABLE_USER_MODE_SUPPORT)
   #include "RegLockMacros.h"
#endif
#include "SchM_Spi.h"
#if (STD_ON == DSPI_IP_DEV_ERROR_DETECT)
    #include "Devassert.h"
#endif
...
==================================================================================================*/
#define DSPI_IP_VENDOR_ID_C                      43
#define DSPI_IP_AR_RELEASE_MAJOR_VERSION_C       4
#define DSPI_IP_AR_RELEASE_MINOR_VERSION_C       7
#define DSPI_IP_AR_RELEASE_REVISION_VERSION_C    0
#define DSPI_IP_SW_MAJOR_VERSION_C               6
#define DSPI_IP_SW_MINOR_VERSION_C               0
#define DSPI_IP_SW_PATCH_VERSION_C               0
/*==================================================================================================
*                                     FILE VERSION CHECKS
==================================================================================================*/
#ifndef DISABLE_MCAL_INTERMODULE_ASR_CHECK
    /* Check if current file and Mcal header file are of the same Autosar version */
    #if ((DSPI_IP_AR_RELEASE_MAJOR_VERSION_C != MCAL_AR_RELEASE_MAJOR_VERSION) || \
         (DSPI_IP_AR_RELEASE_MINOR_VERSION_C != MCAL_AR_RELEASE_MINOR_VERSION))
    #error "AutoSar Version Numbers of Dspi_Ip.c and Mcal.h are different"
    #endif

    #if (DSPI_IP_DMA_USED == STD_ON)
        /* Check if current file and Dma_Ip header file are of the same Autosar version */
        #if ((DSPI_IP_AR_RELEASE_MAJOR_VERSION_C != DMA_IP_AR_RELEASE_MAJOR_VERSION) || \
             (DSPI_IP_AR_RELEASE_MINOR_VERSION_C != DMA_IP_AR_RELEASE_MINOR_VERSION))
        #error "AutoSar Version Numbers of Dspi_Ip.c and Dma_Ip.h are different"
        #endif
    #endif

    #if (STD_ON == DSPI_IP_ENABLE_USER_MODE_SUPPORT)
        #if ((DSPI_IP_AR_RELEASE_MAJOR_VERSION_C != REGLOCKMACROS_AR_RELEASE_MAJOR_VERSION) || \
             (DSPI_IP_AR_RELEASE_MINOR_VERSION_C != REGLOCKMACROS_AR_RELEASE_MINOR_VERSION))
        #error "AutoSar Version Numbers of Dspi_Ip.c and RegLockMacros.h are different"
        #endif
    #endif

    /* Check if the current file and SchM_Spi.h header file are of the same version */
    #if ((DSPI_IP_AR_RELEASE_MAJOR_VERSION_C != SCHM_SPI_AR_RELEASE_MAJOR_VERSION) || \
         (DSPI_IP_AR_RELEASE_MINOR_VERSION_C != SCHM_SPI_AR_RELEASE_MINOR_VERSION) \
        )
        #error "AutoSar Version Numbers of Dspi_Ip.c and SchM_Spi.h are different"
    #endif

    /* Check if the current file and OsIf.h header file are of the same version */
    #if ((DSPI_IP_AR_RELEASE_MAJOR_VERSION_C != OSIF_AR_RELEASE_MAJOR_VERSION) || \
         (DSPI_IP_AR_RELEASE_MINOR_VERSION_C != OSIF_AR_RELEASE_MINOR_VERSION) \
        )
        #error "AutoSar Version Numbers of Dspi_Ip.c and OsIf.h are different"
    #endif
#endif

#if (STD_ON == DSPI_IP_DEV_ERROR_DETECT)
    #ifndef DISABLE_MCAL_INTERMODULE_ASR_CHECK
        /* Check if Dspi_Ip source file and Devassert.h header file are of the same release version */
        #if ((DSPI_IP_AR_RELEASE_MAJOR_VERSION_C != DEVASSERT_AR_RELEASE_MAJOR_VERSION) || \
             (DSPI_IP_AR_RELEASE_MINOR_VERSION_C != DEVASSERT_AR_RELEASE_MINOR_VERSION)    \
            )
            #error "AutoSar Version Numbers of Dspi_Ip.c and Devassert.h are different"
        #endif
    #endif
#endif /* (STD_ON == DSPI_IP_DEV_ERROR_DETECT) */

/* Check if Dspi_Ip.h and Dspi_Ip.c are of the same vendor */
#if (DSPI_IP_VENDOR_ID != DSPI_IP_VENDOR_ID_C)
    #error "Dspi_Ip.h and Dspi_Ip.c have different vendor ids"
#endif
/* Check if Dspi_Ip.h file and Dspi_Ip.c file are of the same Autosar version */
#if ((DSPI_IP_AR_RELEASE_MAJOR_VERSION != DSPI_IP_AR_RELEASE_MAJOR_VERSION_C) || \
     (DSPI_IP_AR_RELEASE_MINOR_VERSION != DSPI_IP_AR_RELEASE_MINOR_VERSION_C) || \
     (DSPI_IP_AR_RELEASE_REVISION_VERSION != DSPI_IP_AR_RELEASE_REVISION_VERSION_C))
#error "AutoSar Version Numbers of Dspi_Ip.h and Dspi_Ip.c are different"
#endif
#if ((DSPI_IP_SW_MAJOR_VERSION != DSPI_IP_SW_MAJOR_VERSION_C) || \
     (DSPI_IP_SW_MINOR_VERSION != DSPI_IP_SW_MINOR_VERSION_C) || \
     (DSPI_IP_SW_PATCH_VERSION != DSPI_IP_SW_PATCH_VERSION_C))
#error "Software Version Numbers of Dspi_Ip.h and Dspi_Ip.c are different"
#endif

/* Check if Dspi_Ip_Cfg.h and Dspi_Ip.c are of the same vendor */
#if (DSPI_IP_VENDOR_ID_CFG != DSPI_IP_VENDOR_ID_C)
    #error "Dspi_Ip_Cfg.h and Dspi_Ip.c have different vendor ids"
#endif
/* Check if Dspi_Ip_Cfg.h file and Dspi_Ip.c file are of the same Autosar version */
#if ((DSPI_IP_AR_RELEASE_MAJOR_VERSION_CFG != DSPI_IP_AR_RELEASE_MAJOR_VERSION_C) || \
     (DSPI_IP_AR_RELEASE_MINOR_VERSION_CFG != DSPI_IP_AR_RELEASE_MINOR_VERSION_C) || \
     (DSPI_IP_AR_RELEASE_REVISION_VERSION_CFG != DSPI_IP_AR_RELEASE_REVISION_VERSION_C))
#error "AutoSar Version Numbers of Dspi_Ip_Cfg.h and Dspi_Ip.c are different"
#endif
#if ((DSPI_IP_SW_MAJOR_VERSION_CFG != DSPI_IP_SW_MAJOR_VERSION_C) || \
     (DSPI_IP_SW_MINOR_VERSION_CFG != DSPI_IP_SW_MINOR_VERSION_C) || \
     (DSPI_IP_SW_PATCH_VERSION_CFG != DSPI_IP_SW_PATCH_VERSION_C))
#error "Software Version Numbers of Dspi_Ip_Cfg.h and Dspi_Ip.c are different"
#endif
/*==================================================================================================
*                          LOCAL TYPEDEFS (STRUCTURES, UNIONS, ENUMS)
==================================================================================================*/
#ifdef CUSTOM_HEADERFILE
#define DSPI_IP_Type DSPI_Custom_Type
#else
#define DSPI_IP_Type DSPI_Type
#endif
...
/* the maximum of Major loop when Minor loop Channel Linking Disabled */
    #define DSPI_IP_DMA_MAX_ITER_CNT_U16    ((uint16)0x7FFFu)
#endif

/* Maximum value of CTARE[DTCP] */
#define DSPI_IP_CTARE_DTCP_MAX_U16          (DSPI_CTARE_DTCP_MASK >> DSPI_CTARE_DTCP_SHIFT)
/* Pushr CONT mask to be used for CMD field which is uint16  */
#define DSPI_IP_PUSHR_CONT_MASK_U16         ((uint16)(DSPI_PUSHR_CONT_MASK >> 16))

#if (DSPI_IP_FCPCS_SUPPORT == STD_ON)
/* Pushr FCPCS mask to be used for CMD field which is uint16  */
#define DSPI_PUSHR_PP_MCSC_MASK_U16         ((uint16)(DSPI_PUSHR_PP_MCSC_MASK >> 16))
#else
#define DSPI_PUSHR_PP_MCSC_MASK_U16         ((uint16)0u)
#endif
/*  Maximum number of bytes that can be written in a FIFO entry */
#define DSPI_TX_WORD_SIZE                   (DSPI_TXFR_TXDATA_WIDTH / 8U)
/*  Maximum number of bytes that can be read from a FIFO entry */
#define DSPI_RX_WORD_SIZE                   (DSPI_RXFR_RXDATA_WIDTH / 8U)

/* Mask Used to reset status registers in SPI mode */
#define DSPI_SR_RESET_MASK ( DSPI_SR_TCF_MASK | DSPI_SR_TXRXS_MASK | DSPI_SR_EOQF_MASK | DSPI_SR_TFFF_MASK | \
                                DSPI_SR_BSYF_MASK | DSPI_SR_CMDTCF_MASK | DSPI_SR_SPEF_MASK | DSPI_SR_RFOF_MASK | \
                                DSPI_SR_TFIWF_MASK | DSPI_SR_RFDF_MASK | DSPI_SR_CMDFFF_MASK )
...
static DSPI_IP_Type* const Dspi_Ip_apxBases[DSPI_INSTANCE_COUNT] = IP_DSPI_BASE_PTRS;
...
==================================================================================================*/
    ...
    #include "Spi_MemMap.h"
static uint32 Dspi_Ip_u32DiscardData;
...
static Dspi_Ip_StateStructureType Dspi_Ip_axStateStructure[DSPI_IP_NUMBER_OF_INSTANCES];
static Dspi_Ip_StateStructureType* Dspi_Ip_apxStateStructureArray[DSPI_INSTANCE_COUNT];
...
static void Dspi_Ip_TransferProcess(uint8 Instance);

#if (DSPI_IP_DMA_USED == STD_ON)
static void Dspi_Ip_CmdDmaTcdSGInit(uint8 Instance);

#if (DSPI_IP_ENABLE_DMAFASTTRANSFER_SUPPORT == STD_ON)
static void Dspi_Ip_CmdDmaTcdSGConfig(uint8 Instance,
                                      uint8 TCDSGId,
                                      uint32 CmdAdd,
                                      uint16 Iter,
                                      uint8 DisHwReq);

static void Dspi_Ip_DmaFastConfig(uint8 Instance,
                                  const Dspi_Ip_FastTransferType *FastTransferCfg,
                                  uint8 NumberOfTransfer);

static void Dspi_Ip_RxDmaTcdSGConfig(uint8 Instance,
                                     uint8 TCDSGIndex,
                                     uint8 DisHwReq);

static void Dspi_Ip_RxDmaTcdSGInit(uint8 Instance);

static void Dspi_Ip_TxDmaTcdSGConfig(uint8 Instance,
                                     uint8 TCDSGIndex,
                                     uint8 DisHwReq);

static void Dspi_Ip_TxDmaTcdSGInit(uint8 Instance);

#endif /* if (DSPI_IP_ENABLE_DMAFASTTRANSFER_SUPPORT == STD_ON) */
#endif /* if (DSPI_IP_DMA_USED == STD_ON) */

static void Dspi_Ip_WriteTxFifo(uint16 NumberOfWrites,
                                uint8 Instance);

static void Dspi_Ip_ReceiveData(uint16 NumberOfReads,
                                uint8 Instance);

static void Dspi_Ip_ChannelFinished(uint8 Instance,
                                    boolean ErrorFlag);

#if (DSPI_IP_DEV_ERROR_DETECT == STD_ON)
static void Dspi_Ip_CheckValidParameters(const Dspi_Ip_ExternalDeviceType *ExternalDevice,
                                         uint16 Length,
                                         uint32 TimeOut);
...
* @return none
*/
static uint16 Dspi_Ip_WriteCmdFifo(Dspi_Ip_StateStructureType* State,
                                   DSPI_IP_Type *Base)
{
    uint16 NumberOfCmdWrites = 0u;
    uint16 i;

    NumberOfCmdWrites = (uint16)((Base->SREX) & DSPI_SREX_CMDCTR_MASK) >> DSPI_SREX_CMDCTR_SHIFT;
    if (NumberOfCmdWrites <= DSPI_IP_FIFO_SIZE_U16)
    {
        NumberOfCmdWrites = DSPI_IP_FIFO_SIZE_U16 - NumberOfCmdWrites;
    }
    else
    {
        /* Handle hw error on bits. Ceil CMDCTR and calculate result: DSPI_IP_FIFO_SIZE_U16 - DSPI_IP_FIFO_SIZE_U16 */
        NumberOfCmdWrites = 0;
    }
...
/**
* @brief   This function is called by Dspi_Ip_IrqHandler or Dspi_Ip_ManageBuffers. It will process transfer in interrupt mode and polling mode.
...
static void Dspi_Ip_TransferProcess(uint8 Instance)
{
    DSPI_IP_Type* Base = Dspi_Ip_apxBases[Instance];
    Dspi_Ip_StateStructureType* State = Dspi_Ip_apxStateStructureArray[Instance];
    uint32 SrStatusRegister;
    uint16 NumberOfReads;
    boolean ErrorFlag = (boolean)FALSE;

    if (DSPI_IP_BUSY == State->Status)
    {
        /* Read Status and clear all flags. */
        SrStatusRegister = Base->SR;
        Base->SR &= 0xFFFF0000u;

        /* DSPI do not support error flag? it will be enabled if those bits are availabe */
        if ((0u != (SrStatusRegister & DSPI_SR_RFOF_MASK)))
        {
            /* mark error flag */
        ...
        else
        {
            ...
            NumberOfReads = (uint16)(((Base->SR) & DSPI_SR_RXCTR_MASK) >> DSPI_SR_RXCTR_SHIFT);
#if ((DSPI_SR_RXCTR_MASK >> DSPI_SR_RXCTR_SHIFT) > DSPI_TXFR_COUNT)
            if (NumberOfReads > DSPI_IP_FIFO_SIZE_U16)
            {
                NumberOfReads = DSPI_IP_FIFO_SIZE_U16;
            }
#endif
            if (NumberOfReads != 0u)
            {
                /* Read data from RX FIFO */
                Dspi_Ip_ReceiveData(NumberOfReads, Instance);
            }
...
#endif
            {
                ...
                {
                    (void)Dspi_Ip_WriteCmdFifo(State, Base);
                }
            }
            ...
            {
                Dspi_Ip_WriteTxFifo(State->CurrentTxFifoSlot, Instance);
        ...
        if ((State->RxIndex == State->ExpectedFifoReads) || ((boolean)TRUE == ErrorFlag))
        {
            ...
            Base->RSER = 0U;
            /* Channel finished */
            Dspi_Ip_ChannelFinished(Instance, ErrorFlag);
        }
    }
}

static void Dspi_Ip_CalculateFifoWords(uint16 FrameSize,
                                       uint16 NbBytes,
                                       uint16 *Frames,
                                       ...
                                       uint16 *RxBytesPerWord)
{
    ...
    *Frames = NbBytes / BytesPerFrame;
    ...
    if (BytesPerWord < DSPI_TX_WORD_SIZE)
    {
        *TxBytesPerWord = BytesPerWord;
    }
    else
    {
        *TxBytesPerWord = DSPI_TX_WORD_SIZE;
    }

    /* Return by maximum bytes that fits in RX FIFO */
    if (BytesPerWord < DSPI_RX_WORD_SIZE)
    {
        *RxBytesPerWord = BytesPerWord;
    }
    else
    {
        *RxBytesPerWord = DSPI_RX_WORD_SIZE;
    }
}

static void Dspi_Ip_UpdateCtarAndPushr(Dspi_Ip_StateStructureType* State,
                                       DSPI_IP_Type *Base)
{
    const Dspi_Ip_ExternalDeviceType *Dev = State->ExternalDevice;
    ...
    {
        Base->MODE.CTAR_SLAVE[0] = CtarSrc | DSPI_CTAR_SLAVE_FMSZ(CtarFrameSize);
    }
    else
#endif
    {
        for (i = 0u; i < State->NbCmds; i++)
        {
            Base->MODE.CTAR[i] = CtarSrc |
                                 DSPI_CTAR_FMSZ(CtarFrameSize) |
                                 DSPI_CTAR_LSBFE(Dev->DeviceParams->Lsb ? 1u : 0u);
            Base->CTARE[i] = Dev->Ctare |
                             DSPI_CTARE_FMSZE(CtareFrameSize) |
                             DSPI_CTARE_DTCP(State->DTCPValue[i]);
            State->PushrCmds[i] = (uint16)(((PushrCmd32 & (~DSPI_PUSHR_CTAS_MASK)) |
                                            DSPI_PUSHR_CTAS(i)) >> 16u);
        }
        /* Update last pushr to clear needed fields */
        if (((State->PushrCmds[i - 1u] & DSPI_IP_PUSHR_CONT_MASK_U16) != 0u) && (State->KeepCs == FALSE))
        {
            State->PushrCmds[i - 1u] &= ~(DSPI_IP_PUSHR_CONT_MASK_U16 | DSPI_PUSHR_PP_MCSC_MASK_U16);
        }
    }
}
...
* @details DSPI_IP_CTARE_DTCP_MAX_U16  will be repeated the needed number of times.
...
* @return void
*/
static void Dspi_Ip_PrepareTransfer(Dspi_Ip_StateStructureType* State,
                                    DSPI_IP_Type *Base,
                                    uint16 NbBytes)
{
    uint16 Frames;
    ...
    Dspi_Ip_CalculateFifoWords(State->ExternalDevice->DeviceParams->FrameSize, NbBytes,
     ...
     *  Case 1: CS_TOGGLE and Frames < DSPI_IP_CTARE_DTCP_MAX_U16
     ...
     *
     *  Case 3: CS_KEEP_ASSERTED and Keep_CS = True and Frames < DSPI_IP_CTARE_DTCP_MAX_U16
     *    - CMD0 uses CTAR0 with DTCP = Frames - 1
     *    - CMD1 uses CTAR1 with DTCP = 1 (Unset CONT bit)
     *
     *  Case 4: CS_KEEP_ASSERTED and Keep_CS = True and Frames > DSPI_IP_CTARE_DTCP_MAX_U16
...
#endif
    {
        if (TRUE == State->KeepCs)
        {
            ...
            if (((State->ExternalDevice->PushrCmd & DSPI_IP_PUSHR_CONT_MASK_U16) != 0u) && (Frames > 1u))
            {
                State->Pushr0Repeat--;
                State->DTCPValue[1] = 1;
                State->NbCmds++;
        ...
        {
            if (Frames < DSPI_IP_CTARE_DTCP_MAX_U16)
            {
                /* Max DTCP value is enough to send Frames. Set 1 CMD to be pushed 1 time */
                State->DTCPValue[0] = Frames % DSPI_IP_CTARE_DTCP_MAX_U16;
            ...
            else
            {
                ...
                */
                State->DTCPValue[0] = DSPI_IP_CTARE_DTCP_MAX_U16;
                State->Pushr0Repeat = Frames / DSPI_IP_CTARE_DTCP_MAX_U16;
                State->DTCPValue[1] = Frames % DSPI_IP_CTARE_DTCP_MAX_U16;
                State->NbCmds++;
            }
    ...
    Dspi_Ip_UpdateCtarAndPushr(State, Base);
}
...
static void Dspi_Ip_CmdDmaTcdSGInit(uint8 Instance)
{
    const DSPI_IP_Type* Base = Dspi_Ip_apxBases[Instance];
    const Dspi_Ip_StateStructureType* State = Dspi_Ip_apxStateStructureArray[Instance];
    ...
    DmaTcdList[8u].Value = 1u;   /* dummy disable hardware request when major loop complete, will be updated latter in the case of Scatter Gather
                                  * enabled */
                                     ...
                                     uint8 DisHwReq)
{
    ...
    /* No need to configure dest address and dest offset due to they are already set by Dspi_Ip_TxDmaTcdSGInit */
    DmaTcdList[0u].Param = DMA_IP_CH_SET_SOURCE_ADDRESS;
                                     ...
                                     uint8 DisHwReq)
{
    ...
    /* No need to configure src address and src offset due to they are already set by Dspi_Ip_RxDmaTcdSGInit */
    ...
    {
        /* Discard data */
        DmaTcdList[0u].Value = (Dma_Ip_uintPtrType)&Dspi_Ip_u32DiscardData;    /* dest address write*/
...
* @return void
*/
static void Dspi_Ip_DmaCmdConfigAndStart(const Dspi_Ip_StateStructureType* State)
{
...
* @return void
*/
static void Dspi_Ip_DmaConfig(const Dspi_Ip_StateStructureType* State,
                              const DSPI_IP_Type *Base)
{
    ...
    {
        /* Discard data */
        DmaTcdList[1u].Value = (Dma_Ip_uintPtrType) & Dspi_Ip_u32DiscardData;    /* dest address write*/
...
* @return void
*/
static void Dspi_Ip_DmaTxRxUpdateLoop(Dspi_Ip_StateStructureType* State)
{
    ...
    if (DSPI_IP_DMA_MAX_ITER_CNT_U16 < NumberDmaIterWrite)
    {
        NumberDmaIterWrite = DSPI_IP_DMA_MAX_ITER_CNT_U16;
    }
...
* @return void
*/
static void Dspi_Ip_DmaAsyncStart(Dspi_Ip_StateStructureType* State,
                                  DSPI_IP_Type *Base,
                                  uint32 IrqEn)
{
    Dma_Ip_LogicChannelTransferListType Tcd = {
    ...
    #endif
    {
        Dspi_Ip_DmaCmdConfigAndStart(State);
    }

    /* Config RX and TX channels */
    Dspi_Ip_DmaConfig(State, Base);
    /* Enable RX and TX channels */
    Dspi_Ip_DmaTxRxUpdateLoop(State);

    /* Enable SPI interrupts and set them to trigger DMA */
    Base->RSER = DSPI_RSER_CMDFFF_RE(1) | DSPI_RSER_CMDFFF_DIRS(1) |
                 DSPI_RSER_TFFF_RE(1) | DSPI_RSER_TFFF_DIRS(1) |
                 DSPI_RSER_RFDF_RE(1) | DSPI_RSER_RFDF_DIRS(1);
}

#endif /*(DSPI_IP_DMA_USED == STD_ON)*/
                                ...
                                uint8 Instance)
{
    ...
    #if (DSPI_IP_DEV_ERROR_DETECT == STD_ON)
    DevAssert(NumberOfWrites <= DSPI_IP_FIFO_SIZE_U16);
    #endif
    if (NULL_PTR != State->TxBuffer)
    {
        if (State->ExternalDevice->DeviceParams->FrameSize < 9u)
...
static void Dspi_Ip_ReceiveData(uint16 NumberOfReads,
                                uint8 Instance)
{
    Dspi_Ip_StateStructureType* const State = Dspi_Ip_apxStateStructureArray[Instance];
    const DSPI_IP_Type* Base = Dspi_Ip_apxBases[Instance];
...
{
    Dspi_Ip_StateStructureType* State = Dspi_Ip_apxStateStructureArray[Instance];
    Dspi_Ip_EventType EventState = DSPI_IP_EVENT_FAULT;

    if (TRUE == ErrorFlag)
    {
        State->Status = DSPI_IP_FAULT;
        EventState = DSPI_IP_EVENT_FAULT;
    }
    else
    {
        State->Status = DSPI_IP_IDLE;
        EventState = DSPI_IP_EVENT_END_TRANSFER;
    }
...
* @return void
*/
static void Dspi_Ip_AsyncStart(Dspi_Ip_StateStructureType* State,
                               DSPI_IP_Type *Base)
{
    #if (DSPI_IP_SLAVE_SUPPORT == STD_ON)
    ...
    /* Enable interrupts. */
    Base->RSER = DSPI_RSER_TCF_RE(1) | DSPI_RSER_RFOF_RE(1);
    ...
    #endif
    {
        ...
        if (State->CurrentTxFifoSlot > 0u)
        {
            Dspi_Ip_WriteTxFifo(State->CurrentTxFifoSlot, State->ExternalDevice->Instance);
            /* Update current TX FIFO slot can be written */
            State->CurrentTxFifoSlot = 0u;
        }
    }
    ...
    else
    {
        ...
        NumberOfWrites = (uint16)((Base->SR) & DSPI_SR_TXCTR_MASK) >> DSPI_SR_TXCTR_SHIFT;
        if (NumberOfWrites < DSPI_IP_FIFO_SIZE_U16)
        {
            NumberOfWrites = DSPI_IP_FIFO_SIZE_U16 - NumberOfWrites;
        }
        else
        {
            /* Handle hw error on bits. Ceil CMDCTR and calculate result: DSPI_IP_FIFO_SIZE_U16 - DSPI_IP_FIFO_SIZE_U16 */
        ...
        #endif
        /* Write to TXFIFO*/
        Dspi_Ip_WriteTxFifo(NumberOfWrites, State->ExternalDevice->Instance);
        /* Update current TX FIFO available */
        State->CurrentTxFifoSlot -= NumberOfWrites;
    }
    #endif /* if (DSPI_IP_SLAVE_SUPPORT == STD_ON) */
}
...
* @return        DSPI_IP_STATUS_SUCCESS: Don't have any errors was found.
...
static void Dspi_Ip_CheckValidParameters(const Dspi_Ip_ExternalDeviceType *ExternalDevice,
                                         ...
                                         uint32 TimeOut)
{
    Dspi_Ip_StateStructureType* State;
    ...
    State = Dspi_Ip_apxStateStructureArray[ExternalDevice->Instance];
    DevAssert(State != NULL_PTR);
#if (DSPI_IP_SERIALIZATION_SUPPORT == STD_ON)
    /* Command frames needs to be enabled in order to use Sync and Async transmit */
    if (State->SerializationStarted)
    {
        DevAssert((boolean)TRUE == State->ExternalDevice->EnableCommandFrames);
    }
#endif
}

#endif /* if (DSPI_IP_DEV_ERROR_DETECT == STD_ON) */
/*==================================================================================================
*                                      GLOBAL FUNCTIONS
==================================================================================================*/
#if (DSPI_IP_DMA_USED == STD_ON)
...
*
* @param[in]     Instance      Index of the hardware instance.
* @implements Dspi_Ip_IrqDmaHandler_Activity
*/
void Dspi_Ip_IrqDmaHandler(uint8 Instance)
{
    ...
    if ((NULL_PTR != State) && (DSPI_IP_BUSY == State->Status))
    {
        /* Read Status and clear all flags. */
        SrStatusRegister = Base->SR;
        Base->SR &= 0xFFFF0000u;
        /* DSPI do not support error flag? it will be enabled if those bits are available */
        if ((0u != (SrStatusRegister & DSPI_SR_RFOF_MASK)))
        {
            /* mark error flag */
            ErrorFlag = (boolean)TRUE;
        ...
        if (((boolean)TRUE == EndOfTransferFlag) || ((boolean)TRUE == ErrorFlag))
        {
            ...
            if (State->Callback != NULL_PTR)
            {
                if ((boolean)TRUE == ErrorFlag)
                {
                    State->Callback(Instance, DSPI_IP_EVENT_FAULT);
                }
                else
                {
                    State->Callback(Instance, DSPI_IP_EVENT_END_TRANSFER);
                }
            }
        }
    }
...
Dspi_Ip_StatusType Dspi_Ip_Init(const Dspi_Ip_ConfigType *PhyUnitConfigPtr)
{
    DSPI_IP_Type* Base;
    Dspi_Ip_StateStructureType* State;
    Dspi_Ip_StatusType Status = DSPI_IP_STATUS_SUCCESS;
    uint8 Instance = 0u;
    ...
    State = Dspi_Ip_apxStateStructureArray[Instance];
    Base = Dspi_Ip_apxBases[Instance];
    #if (DSPI_IP_DEV_ERROR_DETECT == STD_ON)
    DevAssert(State == NULL_PTR);
    #endif
    Dspi_Ip_apxStateStructureArray[Instance] = &Dspi_Ip_axStateStructure[PhyUnitConfigPtr->StateIndex];
    State = Dspi_Ip_apxStateStructureArray[Instance];
    State->PhyUnitConfig = PhyUnitConfigPtr;
    #if (STD_ON == DSPI_IP_ENABLE_USER_MODE_SUPPORT)
    Dspi_Ip_SetUserAccessAllowed(Instance);
    #endif
    ...
    #if (DSPI_IP_DUAL_CLOCK_MODE == STD_ON)
    State->ClockMode = DSPI_IP_NORMAL_CLOCK;
    #endif
    State->KeepCs = (boolean)FALSE;
#if (DSPI_IP_SERIALIZATION_SUPPORT == STD_ON)
    State->SerializationStarted = (boolean)FALSE;
#endif
    #if (DSPI_IP_DMA_USED == STD_ON)
    #if (DSPI_IP_ENABLE_DMAFASTTRANSFER_SUPPORT == STD_ON)
    Dspi_Ip_TxDmaTcdSGInit(Instance);
    Dspi_Ip_RxDmaTcdSGInit(Instance);
    #endif
    if ((boolean)TRUE == State->PhyUnitConfig->DmaUsed)
    {
        Dspi_Ip_CmdDmaTcdSGInit(Instance);
    }

    #endif
    /* set State to idle */
    Status = Dspi_Ip_UpdateTransferMode(Instance, PhyUnitConfigPtr->TransferMode);
    if (DSPI_IP_STATUS_SUCCESS == Status)
    {
        State->Status = DSPI_IP_IDLE;
    }
...
{
    DSPI_IP_Type* Base;
    const Dspi_Ip_StateStructureType* State;
    Dspi_Ip_StatusType Status = DSPI_IP_STATUS_SUCCESS;

    #if (DSPI_IP_DEV_ERROR_DETECT == STD_ON)
    DevAssert(Instance < DSPI_INSTANCE_COUNT);
    #endif
    Base = Dspi_Ip_apxBases[Instance];
    State = Dspi_Ip_apxStateStructureArray[Instance];
    #if (DSPI_IP_DEV_ERROR_DETECT == STD_ON)
    DevAssert(State != NULL_PTR);
    #endif
    if (State->Status == DSPI_IP_BUSY)
    {
        Status = DSPI_IP_STATUS_FAIL;
    }
    else
    {
        /* Halt before update other fields */
        Base->MCR |= DSPI_MCR_HALT_MASK;
        /* Reset FIFOs */
        Base->MCR |= DSPI_MCR_CLR_TXF_MASK | DSPI_MCR_CLR_RXF_MASK;
        Base->MCR = 0x4001u;
        ...
        Dspi_Ip_apxStateStructureArray[Instance] = NULL_PTR;
    }

    return Status;
}

static Dspi_Ip_StatusType Dspi_Ip_IntoBusyState(Dspi_Ip_StateStructureType* State)
{
    Dspi_Ip_StatusType Status = DSPI_IP_STATUS_SUCCESS;
...
static boolean Dspi_Ip_SyncReadWriteStep(Dspi_Ip_StateStructureType *State,
                                         DSPI_IP_Type *Base,
                                         uint8 Instance)
{
    ...
    if (State->ExpectedCmdFifoWrites != 0u)
    {
        if (Dspi_Ip_WriteCmdFifo(State, Base) != 0u)
        {
            StepDone = TRUE;
        }
    }
    ...
    if (State->CurrentTxFifoSlot != 0u)
    {
        ...
        if (((Base->MCR) & DSPI_MCR_HALT_MASK) == DSPI_MCR_HALT_MASK)
        {
            Base->MCR &= ~DSPI_MCR_HALT_MASK;
        }
    }
...
static void Dspi_Ip_TransferInit(Dspi_Ip_StateStructureType *State,
                            const Dspi_Ip_ExternalDeviceType *Dev,
                            const uint8 *TxBuffer,
                            uint8 *RxBuffer,
                            uint16 Length)
{
    DSPI_Type *Base = Dspi_Ip_apxBases[Dev->Instance];

    /* Update State structure. */
    State->TxBuffer = TxBuffer;
    State->RxBuffer = RxBuffer;
    State->CurrentTxFifoSlot = DSPI_IP_FIFO_SIZE_U16;
    State->ExternalDevice = Dev;

    Dspi_Ip_PrepareTransfer(State, Base, Length);
    /* Make sure that FIFOs will be empty before start new transfer session */
    Base->MCR |= DSPI_MCR_CLR_TXF_MASK | DSPI_MCR_CLR_RXF_MASK;
    /* Reset Flags */
    Base->SR = DSPI_SR_RESET_MASK;
}

/*================================================================================================*/
Dspi_Ip_StatusType Dspi_Ip_SyncTransmit(const Dspi_Ip_ExternalDeviceType *ExternalDevice,
                                        const uint8 *TxBuffer,
                                        uint8 *RxBuffer,
                                        uint16 Length,
                                        uint32 TimeOut)
{
    ...
    Dspi_Ip_StateStructureType *State;
    Dspi_Ip_StatusType Status = DSPI_IP_STATUS_SUCCESS;
    uint32 TimeoutTicks = OsIf_MicrosToTicks(TimeOut, DSPI_IP_TIMEOUT_METHOD);
    ...
    #if (STD_ON == DSPI_IP_DEV_ERROR_DETECT)
    Dspi_Ip_CheckValidParameters(ExternalDevice, Length, TimeOut);
    #endif
    Instance = ExternalDevice->Instance;
    State = Dspi_Ip_apxStateStructureArray[Instance];

    Base = Dspi_Ip_apxBases[Instance];
    Status = Dspi_Ip_IntoBusyState(State);
#if (DSPI_IP_SERIALIZATION_SUPPORT == STD_ON)
    if ((DSPI_IP_STATUS_SUCCESS == Status) &&
        ((boolean)TRUE == State->SerializationStarted) &&
        (ExternalDevice != State->ExternalDevice))
    {
        /* Only one external device can do transmits when [de]serialization is enabled */
        Status = DSPI_IP_STATUS_FAIL;
        State->Status = DSPI_IP_IDLE;
    }
#endif
    if (DSPI_IP_STATUS_SUCCESS == Status)
    {
        Dspi_Ip_TransferInit(State, ExternalDevice, TxBuffer, RxBuffer, Length);
        CurrentTicks = OsIf_GetCounter(DSPI_IP_TIMEOUT_METHOD); /* initialize current counter */
        while (DSPI_IP_STATUS_SUCCESS == Status)
        {
            /* Read and write FIFO registers */
            StepDone = Dspi_Ip_SyncReadWriteStep(State, Base, Instance);
            if (StepDone)
            {
            ...
            ElapsedTicks += OsIf_GetElapsed(&CurrentTicks, DSPI_IP_TIMEOUT_METHOD);
            if (ElapsedTicks >= TimeoutTicks)
            {
                Status = DSPI_IP_TIMEOUT;
            }
        }

        /* Only set HALT bit to stop transfer when there is a error or request to de-assert CS at the end of transfers sequence */
        if ((DSPI_IP_STATUS_SUCCESS != Status) || ((boolean)FALSE == State->KeepCs))
        {
            /* Stop transfer */
            Base->MCR |= DSPI_MCR_HALT_MASK;
        }
        ...
        /* Channel finished */
        Dspi_Ip_ChannelFinished(Instance, FALSE);
    }

    return Status;
}

Dspi_Ip_StatusType Dspi_Ip_AsyncTransmit(const Dspi_Ip_ExternalDeviceType *ExternalDevice,
                                         const uint8 *TxBuffer,
                                         uint8 *RxBuffer,
                                         uint16 Length,
                                         Dspi_Ip_CallbackType EndCallback)
{
    ...
    #if (STD_ON == DSPI_IP_DEV_ERROR_DETECT)
    Dspi_Ip_CheckValidParameters(ExternalDevice, Length, 1u);
    #endif
    State = Dspi_Ip_apxStateStructureArray[ExternalDevice->Instance];
    Base = Dspi_Ip_apxBases[ExternalDevice->Instance];
    Status = Dspi_Ip_IntoBusyState(State);
#if (DSPI_IP_SERIALIZATION_SUPPORT == STD_ON)
    if ((DSPI_IP_STATUS_SUCCESS == Status) &&
        ((boolean)TRUE == State->SerializationStarted) &&
    ...
    if (DSPI_IP_STATUS_SUCCESS == Status)
    {
        ...
        #endif
        {
            if (State->TransferMode == DSPI_IP_POLLING)
            {
                /* Disable interrupts and DMA requests. */
                Base->RSER = 0U;
            }
        ...
        {
            Dspi_Ip_DmaAsyncStart(State, Base, (State->TransferMode == DSPI_IP_POLLING) ? 0u : 1u);
        }
        #endif
...
Dspi_Ip_StatusType Dspi_Ip_AsyncTransmitFast(const Dspi_Ip_FastTransferType *FastTransferCfg,
                                             uint8 NumberOfTransfer,
                                             Dspi_Ip_CallbackType EndCallback)
{
    DSPI_IP_Type* Base;
    ...
    State = Dspi_Ip_apxStateStructureArray[FastTransferCfg[0u].ExternalDevice->Instance];

    DevAssert(NULL_PTR != State);
    DevAssert(State->TransferMode == DSPI_IP_INTERRUPT);
    ...
    for (Count = 0u; Count < NumberOfTransfer; Count++)
    {
        ...
        {
            DevAssert(DSPI_IP_DMA_MAX_ITER_CNT_U16 >= FastTransferCfg[Count].Length);
        }
    }
    ...
    else
    {
        ...
        State->Callback = EndCallback;
        /* Stop transfer at the end of transfers sequence by set HALT bit in Dspi_Ip_IrqDmaHandler */
        State->KeepCs = (boolean)FALSE;

        /* Configure external device parameters  like: frane size, clock phase, clock polarity. */
        #if (DSPI_IP_DUAL_CLOCK_MODE == STD_ON)
        Base->MODE.CTAR[0u] = FastTransferCfg[0u].ExternalDevice->Ctar[State->ClockMode] | DSPI_CTAR_FMSZ(((uint32)State->ExternalDevice->DeviceParams->FrameSize - 1u) & 0xFu) | DSPI_CTAR_LSBFE(LsbValue);
        #else
        Base->MODE.CTAR[0u] = FastTransferCfg[0u].ExternalDevice->Ctar | DSPI_CTAR_FMSZ(((uint32)State->ExternalDevice->DeviceParams->FrameSize - 1u) & (uint32)0xFu) | DSPI_CTAR_LSBFE(LsbValue);
        #endif
        Base->CTARE[0u] = FastTransferCfg[0u].ExternalDevice->Ctare | DSPI_CTARE_FMSZE((((uint32)State->ExternalDevice->DeviceParams->FrameSize - 1u) >> 4u) & (uint32)0x1u);
        /* Config and Enable DMA request. */
        Dspi_Ip_DmaFastConfig(Instance, FastTransferCfg, NumberOfTransfer);
        Base->RSER = DSPI_RSER_CMDFFF_RE(1u) | DSPI_RSER_CMDFFF_DIRS(1u) | DSPI_RSER_TFFF_RE(1u) | DSPI_RSER_TFFF_DIRS(1u) | DSPI_RSER_RFDF_RE(1u) | DSPI_RSER_RFDF_DIRS(1u);
                                  ...
                                  uint8 NumberOfTransfer)
{
    ...
    for (Count = 0u; Count < NumberOfTransfer; Count++)
    {
        ...
        State->PhyUnitConfig->CmdDmaFast[Count].DmaFastPushrCmdLast = 
            FastTransferCfg[Count].ExternalDevice->PushrCmd & ~(DSPI_IP_PUSHR_CONT_MASK_U16 | DSPI_PUSHR_PP_MCSC_MASK_U16);
        ...
        if ((boolean)TRUE == ClearCS)
        {
            ...
            {
                Dspi_Ip_CmdDmaTcdSGConfig(Instance,
                                          ...
                                          0u    /* not disable dma hw request, the transfer will be continued after next software TCD Scatter Gather
                                                 * loaded */
                                         );
                CmdTCDSGIndex++;
            }
        ...
        Dspi_Ip_TxDmaTcdSGConfig(Instance, Count, DisHwRequest);

        /* Configure software TCDs Scatter Gather for RX DMA channel */
        Dspi_Ip_RxDmaTcdSGConfig(Instance, Count, DisHwRequest);
    }
...
#endif /* if ((DSPI_IP_DMA_USED == STD_ON) && (DSPI_IP_ENABLE_DMAFASTTRANSFER_SUPPORT == STD_ON)) */
...
void Dspi_Ip_ManageBuffers(uint8 Instance)
{
    ...
    DevAssert(State != NULL_PTR);
    #endif
    if (DSPI_IP_POLLING == State->TransferMode)
    {
        #if (DSPI_IP_DMA_USED == STD_ON)
        if ((boolean)FALSE == State->PhyUnitConfig->DmaUsed)
        #endif
        {
            Dspi_Ip_TransferProcess(Instance);
        }
        ...
        else
        {
            ...
            if ((boolean)TRUE == DmaChannelStatus.Done)
            {
                ...
                Dspi_Ip_IrqDmaHandler(Instance);
            }
        }
        #endif /* if (DSPI_IP_DMA_USED == STD_ON) */
    }
...
/*================================================================================================*/
Dspi_Ip_StatusType Dspi_Ip_UpdateTransferParam(const Dspi_Ip_ExternalDeviceType *ExternalDevice,
                                               const Dspi_Ip_TransferAdjustmentType *Param)
{
    Dspi_Ip_StateStructureType* State;
    Dspi_Ip_StatusType Status = DSPI_IP_STATUS_SUCCESS;
    ...
    DevAssert(NULL_PTR != Dspi_Ip_apxStateStructureArray[ExternalDevice->Instance]);
    #endif
...
Dspi_Ip_StatusType Dspi_Ip_UpdateFrameSize(const Dspi_Ip_ExternalDeviceType *ExternalDevice,
                                           uint8 FrameSize)
{
    const Dspi_Ip_StateStructureType* State;
    Dspi_Ip_StatusType Status = DSPI_IP_STATUS_SUCCESS;
    ...
    #if (DSPI_IP_DEV_ERROR_DETECT == STD_ON)
    DevAssert(ExternalDevice != NULL_PTR);
    DevAssert(DSPI_IP_FRAMESIZE_MAX_U8 >= FrameSize);
    DevAssert(DSPI_IP_FRAMESIZE_MIN_U8 <= FrameSize);
    #endif
    State = Dspi_Ip_apxStateStructureArray[ExternalDevice->Instance];
    #if (DSPI_IP_DEV_ERROR_DETECT == STD_ON)
    DevAssert(State != NULL_PTR);
...
Dspi_Ip_StatusType Dspi_Ip_UpdateLsb(const Dspi_Ip_ExternalDeviceType *ExternalDevice,
                                     boolean Lsb)
{
    const Dspi_Ip_StateStructureType* State;
    Dspi_Ip_StatusType Status = DSPI_IP_STATUS_SUCCESS;
...
Dspi_Ip_StatusType Dspi_Ip_UpdateDefaultTransmitData(const Dspi_Ip_ExternalDeviceType *ExternalDevice,
                                                     uint32 DefaultData)
{
    const Dspi_Ip_StateStructureType* State;
    Dspi_Ip_StatusType Status = DSPI_IP_STATUS_SUCCESS;
...
Dspi_Ip_StatusType Dspi_Ip_UpdateTransferMode(uint8 Instance,
                                              Dspi_Ip_ModeType Mode)
{
    Dspi_Ip_StateStructureType* State;
    Dspi_Ip_StatusType Status = DSPI_IP_STATUS_SUCCESS;
...
void Dspi_Ip_Cancel(uint8 Instance)
{
                 ...
                 if (DSPI_IP_BUSY == State->Status)
    {
        ...
        #endif /* if (DSPI_IP_DMA_USED == STD_ON) */
        /* Clear FIFO */
        Base->MCR |= (DSPI_MCR_CLR_RXF_MASK | DSPI_MCR_CLR_TXF_MASK);
        /* set State to idle */
        State->Status = DSPI_IP_IDLE;
    }
...
* @details This function will process activities for flags TCF
*
* @param[in]     Instance            Instance of the hardware unit.
*
* @implements Dspi_Ip_IrqHandler_Activity
*/
void Dspi_Ip_IrqHandler(uint8 Instance)
{
    ...
    if (NULL_PTR != State)
    {
        ...
        IrqFlags = Base->SR & (DSPI_SR_TCF_MASK | DSPI_SR_RFOF_MASK | DSPI_SR_DDIF_MASK);
        IrqFlags &= Base->RSER & (DSPI_RSER_TCF_RE_MASK | DSPI_RSER_RFOF_RE_MASK | DSPI_RSER_DDIF_RE_MASK);
#if (DSPI_IP_SERIALIZATION_SUPPORT == STD_ON)
        if (0u != (IrqFlags & DSPI_SR_DDIF_MASK))
        {
            State->ExternalDevice->SerializationNotification(Instance, DSPI_IP_EVENT_COMPARE_MATCH);
            IrqFlags &= ~DSPI_SR_DDIF_MASK;
            Base->SR &= DSPI_SR_DDIF_MASK;
            if (State->ExternalDevice->StopOnInterrupt) 
            {
                Dspi_Ip_SerializationStop(State->ExternalDevice);
            }
        }
#endif
        if (0u != IrqFlags)
...
{
    const Dspi_Ip_StateStructureType* State;
    Dspi_Ip_HwStatusType Status = DSPI_IP_UNINIT;
...
#if (DSPI_IP_DUAL_CLOCK_MODE == STD_ON)
Dspi_Ip_StatusType Dspi_Ip_SetClockMode(uint8 Instance,
                                        Dspi_Ip_DualClockModeType ClockMode)
{
    Dspi_Ip_StateStructureType* State;
    Dspi_Ip_StatusType Status = DSPI_IP_STATUS_SUCCESS;
...
#endif /* if (DSPI_IP_DUAL_CLOCK_MODE == STD_ON) */
