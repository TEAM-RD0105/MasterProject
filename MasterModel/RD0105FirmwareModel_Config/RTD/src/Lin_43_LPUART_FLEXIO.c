...
#define LIN_43_LPUART_FLEXIO_SW_MAJOR_VERSION_C               6
...
static Std_ReturnType Lin_43_LPUART_FLEXIO_CommonCheckingChannel(const uint8 Channel, const uint8 FunctionalId)
{
...
#if (LIN_43_LPUART_FLEXIO_MULTIPARTITION_SUPPORT == STD_ON)
    /* Check for invalid Partition ID */
    if (LIN_43_LPUART_FLEXIO_MAX_PARTITIONS <= PartitionID)
    {
    #if (LIN_43_LPUART_FLEXIO_DEV_ERROR_DETECT == STD_ON)
    ...
    else if (LIN_43_LPUART_FLEXIO_INIT != Lin_43_LPUART_FLEXIO_au8LinDrvStatus[PartitionID])
#else
    if (LIN_43_LPUART_FLEXIO_INIT != Lin_43_LPUART_FLEXIO_au8LinDrvStatus[PartitionID])
#endif /* (LIN'_43_LPUART_FLEXIO_MULTIPARTITION_SUPPORT == STD_ON) */
    {
#if (LIN_43_LPUART_FLEXIO_DEV_ERROR_DETECT == STD_ON)
...
#if (LIN_43_LPUART_FLEXIO_DEV_ERROR_DETECT == STD_OFF)
            /* Casting to avoid misra and compiler warning */
            (void)FunctionalId;
#endif /* (LIN_43_LPUART_FLEXIO_DEV_ERROR_DETECT == STD_OFF) */
        }
    }
...
void Lin_43_LPUART_FLEXIO_Init(const Lin_43_LPUART_FLEXIO_ConfigType * Config)
{
    ...
    else if (LIN_43_LPUART_FLEXIO_UNINIT != Lin_43_LPUART_FLEXIO_au8LinDrvStatus[PartitionID])
#else
...
#endif /* (LIN_43_LPUART_FLEXIO_PRECOMPILE_SUPPORT != STD_ON) */
    }
}
/**
