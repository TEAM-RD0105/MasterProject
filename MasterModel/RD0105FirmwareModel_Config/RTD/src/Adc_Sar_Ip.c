...
#define ADC_SAR_IP_SW_MAJOR_VERSION_C               6
                                                   ...
                                                   const Adc_Sar_Ip_SelfTestThresholdType * SelfTestThresholdConfig)
{
    ...
    if (Instance >= ADC_INSTANCE_COUNT)
    {
        AdcAEBasePtr = Adc_Sar_AE_Ip_apxAdcBase[Instance - ADC_INSTANCE_COUNT];
#ifdef ADC_STAW0R_AWDE
        STAW0RAddr = (volatile uint32 *)&(AdcAEBasePtr->STAW0R);
#endif /* ADC_STAW0R_AWDE */
#ifdef ADC_STAW1R_AWDE
        STAW1RAddr = (volatile uint32 *)&(AdcAEBasePtr->STAW1R);
#endif /* ADC_STAW1R_AWDE */
#ifdef ADC_STAW1AR_AWDE
        STAW1ARAddr = (volatile uint32 *)&(AdcAEBasePtr->STAW1AR);
        STAW1BRAddr = (volatile uint32 *)&(AdcAEBasePtr->STAW1BR);
#endif /* ADC_STAW1AR_AWDE */
#ifdef ADC_STAW2R_AWDE
        STAW2RAddr = (volatile uint32 *)&(AdcAEBasePtr->STAW2R);
#endif /* ADC_STAW2R_AWDE */
#ifdef ADC_STAW4R_AWDE
        STAW4RAddr = (volatile uint32 *)&(AdcAEBasePtr->STAW4R);
        STAW5RAddr = (volatile uint32 *)&(AdcAEBasePtr->STAW5R);
#endif /* ADC_STAW4R_AWDE */
    }
    else
#endif /* ADC_SAR_IP_APPLICATION_EXTENSION_AVAILABLE */
...
static inline void Adc_CheckAndCallAllChannelNotification(const uint32 Instance)
{
    ...
    if (Instance >= ADC_INSTANCE_COUNT)
    {
        AdcAEBasePtr = Adc_Sar_AE_Ip_apxAdcBase[Instance - ADC_INSTANCE_COUNT];
#if (STD_ON == ADC_SAR_IP_EOC_ENABLED)
        IMRAddr = (volatile uint32 *)&(AdcAEBasePtr->IMR);
        ISRAddr = (volatile uint32 *)&(AdcAEBasePtr->ISR);
#endif /* (STD_ON == ADC_SAR_IP_EOC_ENABLED) */
#if (STD_ON == ADC_SAR_IP_WDG_ENABLED)
        WTISRAddr = (volatile uint32 *)&(AdcAEBasePtr->WTISR);
#endif /* (STD_ON == ADC_SAR_IP_WDG_ENABLED) */
    }
    else
#endif /* ADC_SAR_IP_APPLICATION_EXTENSION_AVAILABLE */
...
Adc_Sar_Ip_StatusType Adc_Sar_Ip_SelfTest(const uint32 u32Instance)
{
    ...
    uint32 BackupVdacAnaTest0;
#endif
#ifdef ADC_GPADC_ANA_CONF_VIN_SE_REF
    uint32 BackupVinSeRefAnaConf;
#endif
...
#endif /* ADC_SAR_IP_HAS_SELFTEST_USE_CH32 */
#if ADC_SAR_IP_HAS_SELFTEST_STCR1
            STCR1Addr = (volatile uint32 *)&(AdcAEBasePtr->STCR1);
#endif /* ADC_SAR_IP_HAS_SELFTEST_STCR1 */
            STCR2Addr = (volatile uint32 *)&(AdcAEBasePtr->STCR2);
#if ADC_SAR_IP_HAS_SELFTEST_STCR3
            STCR3Addr = (volatile uint32 *)&(AdcAEBasePtr->STCR3);
#endif /* ADC_SAR_IP_HAS_SELFTEST_STCR3 */
        }
        else
#endif /* ADC_SAR_IP_APPLICATION_EXTENSION_AVAILABLE */
...
#ifdef ADC_GPADC_ANA_TEST0_VDAC
                /* Save the current state of GPADC_ANA_TEST0[ADAC] in order to restore it */
                BackupVdacAnaTest0 = AdcBasePtr->GPADC_ANA_TEST0;
...
#ifdef ADC_GPADC_ANA_CONF_VIN_SE_REF
                /* Save the current state of GPADC_ANA_CONF[VIN_SE_REF] in order to restore it */
                BackupVinSeRefAnaConf = AdcBasePtr->GPADC_ANA_CONF;
#endif
...
#ifdef ADC_GPADC_ANA_TEST0_VDAC
                /* Restore the state of GPADC_ANA_TEST0[VDAC] */
                AdcBasePtr->GPADC_ANA_TEST0 = BackupVdacAnaTest0;
#endif /* ADC_GPADC_ANA_TEST0_VDAC */
#ifdef ADC_GPADC_ANA_CONF_VIN_SE_REF
                /* Restore the state of GPADC_ANA_CONF[VIN_SE_REF] */
                AdcBasePtr->GPADC_ANA_CONF = BackupVinSeRefAnaConf;
#endif /* ADC_GPADC_ANA_CONF_VIN_SE_REF */
...
Adc_Sar_Ip_StatusType Adc_Sar_Ip_DoCalibration(const uint32 u32Instance)
{
    ...
    if (u32Instance >= ADC_INSTANCE_COUNT)
    {
        ...
        CALBISTREGAddr = (volatile uint32 *)&(AdcAEBasePtr->CALBISTREG);
#if defined(ADC_CAL2_ENX_MASK)
        CAL2Addr = (volatile uint32 *)&(AdcAEBasePtr->CAL2);
#endif /* defined(ADC_CAL2_ENX_MASK) */
    }
    else
#endif /* ADC_SAR_IP_APPLICATION_EXTENSION_AVAILABLE */
