...
#define RM_AXBS_IP_SW_MAJOR_VERSION_C               6
...
/* Checks against Axbs_Ip.h */
    ...
    #error "Software Version Numbers of Axbs_Ip.c and Axbs_Ip.h are different"
        ...
        #ifdef AXBS_IP_ENABLE_USER_MODE_SUPPORT
            #ifndef USER_MODE_REG_PROT_ENABLED
                /* Check if the files Axbs_Ip.c and RegLockMacros.h are of the same version */
                #if ((RM_AXBS_IP_AR_RELEASE_MAJOR_VERSION_C != REGLOCKMACROS_AR_RELEASE_MAJOR_VERSION) || \
                     (RM_AXBS_IP_AR_RELEASE_MINOR_VERSION_C != REGLOCKMACROS_AR_RELEASE_MINOR_VERSION)    \
                    )
                    #error "AUTOSAR Version Numbers of Axbs_Ip.c and RegLockMacros.h are different"
                #endif
            #endif
        #endif
    #endif
...
void Axbs_Ip_Crs_Write(uint32 u32Addr,
                       uint32 value);
...
void Axbs_Ip_Prs_Write(uint32 u32Addr,
                       uint32 value);
...
uint32 Axbs_Ip_Crs_Read(uint32 u32Addr)
{
    ...
    */
    ...
    #endif
#endif /* ifdef RM_CROSSBAR_PRS_READONLY */
...
#endif /* ifdef AXBS_IP_ENABLE_USER_MODE_SUPPORT */
    }
