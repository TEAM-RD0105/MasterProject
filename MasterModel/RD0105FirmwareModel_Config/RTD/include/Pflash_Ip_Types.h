...
#define RM_PFLASH_IP_TYPES_SW_MAJOR_VERSION               6
...
typedef struct
{
    ...
    const Pflash_Ip_MasterProtectionType *pPflash_MasterProtectionConfig;              /*!< Pflash Master Protection configuration array*/
