...
#define CDD_MCL_SW_MAJOR_VERSION                6
 ...
 *          edge of the selected sync pulse. When enable multi partitions, the API shall write the
 ...
 * */
void Mcl_SetLcuSyncInputSwSyncMode(const Mcl_LcuSyncInputValueType List[],
                                   const uint8 Dimension
                                  );
