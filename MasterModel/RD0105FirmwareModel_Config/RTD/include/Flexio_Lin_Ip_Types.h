...
#define FLEXIO_LIN_IP_TYPES_SW_MAJOR_VERSION             6
...
typedef enum
{
    ...
    FLEXIO_LIN_IP_STATUS_DMA_ERROR        = 0x0FU     /*!< @brief Operation has had DMA error  */
...
/*!
 * @brief Description: This type defines transfer using DMA or Interrupt mode, DMA only is available on receive the response frame
 * @implements Flexio_Lin_Ip_TransferType_enum
 */
typedef enum
{
    FLEXIO_LIN_IP_USING_DMA         = 0U,    /**< @brief The driver will use DMA to perform FLEXIO transfer */
    FLEXIO_LIN_IP_USING_INTERRUPTS  = 1U     /**< @brief The driver will use interrupts to perform FLEXIO transfer */
} Flexio_Lin_Ip_TransferType;
/*==================================================================================================
 ...
 * @implements Flexio_Lin_Ip_UserConfigType_structure
 */
typedef struct
{
    ...
    Flexio_Lin_Ip_TransferType TransferType;      /*!< @briefType of FLEXIO transfer (interrupt/dma based) */
#if (FLEXIO_LIN_IP_HAS_DMA_ENABLED == STD_ON)
    uint8 RxDMAChannel;                           /**< @brief DMA Rx channel number. Only used in DMA mode */
#endif
