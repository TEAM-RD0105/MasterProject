...
#define CDD_I2C_IPW_SW_MAJOR_VERSION              6
...
* @param[in] ConfigPtr Configuration pointer containing hardware specific settings.
*
*/
...
*                               and the data buffer
* @param[in]   HwConfigType    Pointer to the configuration structure
*
