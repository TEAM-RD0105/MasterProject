...
#define RM_MSCM_IP_TYPES_SW_MAJOR_VERSION               6
...
#endif
/* Check if current file and Mscm_Ip_CfgDefines header file are of the same Autosar version */
#if ((RM_MSCM_IP_TYPES_AR_RELEASE_MAJOR_VERSION    != RM_MSCM_IP_CFG_DEFINES_AR_RELEASE_MAJOR_VERSION) || \
     (RM_MSCM_IP_TYPES_AR_RELEASE_MINOR_VERSION    != RM_MSCM_IP_CFG_DEFINES_AR_RELEASE_MINOR_VERSION) || \
     (RM_MSCM_IP_TYPES_AR_RELEASE_REVISION_VERSION != RM_MSCM_IP_CFG_DEFINES_AR_RELEASE_REVISION_VERSION) \
    )
    #error "AutoSar Version Numbers of Mscm_Ip_Types.h and Mscm_Ip_Cfg_Defines.h are different"
#endif
/* Check if current file and Mscm_Ip_CfgDefines header file are of the same Software version */
