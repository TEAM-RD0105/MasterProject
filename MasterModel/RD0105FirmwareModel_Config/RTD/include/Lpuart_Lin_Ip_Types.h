...
#define LPUART_LIN_IP_TYPES_SW_MAJOR_VERSION             6
...
typedef enum
{
    ...
    LPUART_LIN_IP_STATUS_DMA_ERROR        = 0x0FU     /*!< @brief Operation has had DMA error  */
 ...
 * @implements Lpuart_Lin_Ip_TransferType_enum
 */
typedef enum
{
    LPUART_LIN_IP_USING_DMA         = 0U,    /**< @brief The driver will use DMA to perform UART transfer */
    LPUART_LIN_IP_USING_INTERRUPTS  = 1U     /**< @brief The driver will use interrupts to perform UART transfer */
} Lpuart_Lin_Ip_TransferType;
/**
...
typedef struct
{
    ...
    Lpuart_Lin_Ip_TransferType TransferType;                /*!< @briefType of LPUART transfer (interrupt/dma based) */
