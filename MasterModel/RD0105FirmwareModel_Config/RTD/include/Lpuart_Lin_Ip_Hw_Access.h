...
#define LPUART_LIN_IP_HW_ACCESS_SW_MAJOR_VERSION             6
 ...
 *
 */
void Lpuart_Lin_Ip_HwSetTransmitterCmd(LPUART_Type * Base, boolean Enable);
 ...
 *
 */
void Lpuart_Lin_Ip_HwSetReceiverCmd(LPUART_Type * Base, boolean Enable);
 ...
 */
static inline void Lpuart_Lin_Ip_ClearErrorFlags(LPUART_Type * Base)
{
    ...
    Base->STAT = (Base->STAT & (~LPUART_LIN_IP_STAT_REG_FLAGS_MASK)) | Mask;
}
/**
 * @internal
 ...
 * @param Base LPUART Base pointer
 */
static inline void Lpuart_Lin_Ip_FlushRxBuffer(LPUART_Type * Base)
{
 ...
 */
static inline void Lpuart_Lin_Ip_SetRxDmaCmd(LPUART_Type * Base, boolean Enable)
{
