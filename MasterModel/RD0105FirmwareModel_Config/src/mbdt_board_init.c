...
__attribute__((weak))void Adc_Adc0Group2Notification(void) {
    ;
}

__attribute__((weak))void Adc_Adc0Group3Notification(void) {
    ;
}

__attribute__((weak))void Adc_Adc0Group4Notification(void) {
    ;
}
...
__attribute__((weak))void Adc_Adc2Group2Notification(void) {
    ;
}

__attribute__((weak))void Adc_Adc2Group3Notification(void) {
    ;
}

__attribute__((weak))void Adc_Adc2Group4Notification(void) {
    ;
}

__attribute__((weak))void Adc_Adc2Group5Notification(void) {
    ;
}

__attribute__((weak))void Adc_Adc2Group6Notification(void) {
    ;
}
...
__attribute__((weak))void PwmChannel_10_Callback(void) {
    ;
}

__attribute__((weak))void PwmChannel_11_Callback(void) {
    ;
}
...
__attribute__((weak))void PwmChannel_9_Callback(void) {
    ;
}
